/** biome-ignore-all lint/correctness/useExhaustiveDependencies: All the included deps are needed */
...
function SidebarProvider({
    ...
    const setOpen = React.useCallback(
        (value: boolean | ((data: boolean) => boolean)) => {
            ...
            cookieStore
                .set({
                    ...
                    path: "/",
                    expires:
                        Math.floor(Date.now() / 1000) + SIDEBAR_COOKIE_MAX_AGE,
                })
                .catch((err) =>
...
function SidebarMenuAction({
    ...
    const opacityClass = showOnHover
...
function SidebarMenuSkeleton({
    ...
    return (
        <div
            ...
            {...props}
        >
            {/** biome-ignore lint/nursery/noLeakedRender: No leakage here */}
            {showIcon && (
                <Skeleton
